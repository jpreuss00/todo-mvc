...
function () {
  function TodoListModel(items) {
    ...
    this.todoListe = _toConsumableArray(items);
  }
...
var existingTodos = [new Todo("call peter"), new Todo("talk to susi")];
var todoModel = new TodoListModel(existingTodos);
var todoView = new TodoListView(todoModel);
var todoController = new TodoListController(todoModel, todoView); // connect the html with the controller
